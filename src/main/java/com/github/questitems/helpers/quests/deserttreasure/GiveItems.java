...
public class GiveItems extends NpcStep
{
	...
	public GiveItems(github.questitems github.questitems, int npcID, WorldPoint worldPoint, String text, ItemRequirement... itemRequirements)
	{
		super(github.questitems, npcID, worldPoint, text, itemRequirements);
