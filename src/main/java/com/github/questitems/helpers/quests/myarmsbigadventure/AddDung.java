...
public class AddDung extends ObjectStep
{
	...
	public AddDung(github.questitems github.questitems)
	{
		super(github.questitems, NullObjectID.NULL_18867, new WorldPoint(2831, 3696, 0), "Add 3 ugthanki dung on My Arm's soil patch.");
