...
public class ChanceChallenge extends DetailedOwnerStep
{
	...
	public ChanceChallenge(github.questitems github.questitems)
	{
		super(github.questitems, "Flip the dice to sum up to the correct number.");
		setupSolutions();
	}
	...
	{
		talk = new NpcStep(getgithub.questitems(), NpcID.ETHEREAL_FLUKE, new WorldPoint(1737, 5068, 2), "Talk to the Ethereal Fluke, and solve his puzzle.");
		talk.addDialogStep("Suppose I may as well have a go.");

		spinD1 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17019, new WorldPoint(1735, 5064, 2), "Flip the centre west die.");
		spinD2 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17024, new WorldPoint(1737, 5063, 2), "Flip the centre east die.");
		spinD3 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17023, new WorldPoint(1732, 5067, 2), "Flip the north west die.");
		spinD4 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17020, new WorldPoint(1732, 5060, 2), "Flip the south west die.");
		spinD5 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17022, new WorldPoint(1739, 5067, 2), "Flip the north east die.");
		spinD6 = new ObjectStep(getgithub.questitems(), NullObjectID.NULL_17021, new WorldPoint(1739, 5060, 2), "Flip the south east die.");
	}
