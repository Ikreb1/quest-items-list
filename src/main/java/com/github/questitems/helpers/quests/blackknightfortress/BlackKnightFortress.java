package com.github.questitems.helpers.quests.blackknightfortress;
...
@QuestDescriptor(
	quest = github.questitemsQuest.BLACK_KNIGHTS_FORTRESS
)
public class BlackKnightFortress extends Basicgithub.questitems
{
	//Items Required
