...
@QuestDescriptor(quest = github.questitemsQuest.BENEATH_CURSED_SANDS)
@Slf4j
public class BeneathCursedSands extends Basicgithub.questitems
{
	// Items Required
...
//		defeatMenaphiteShadow = new NpcStep(this, NpcID.MENAPHITE_SHADOW, "Quickly defeat the Menaphite Shadow, which attack using Ranged and Magic and can deal large damage.");
	...
	public List<Requirement> getGeneralRequirements()
	{
		...
		req.add(new QuestRequirement(github.questitemsQuest.CONTACT, QuestState.FINISHED));
