package com.github.questitems.helpers.quests.scorpioncatcher;
...
@QuestDescriptor(
		quest = github.questitemsQuest.SCORPION_CATCHER
)
public class ScorpionCatcher extends Basicgithub.questitems
{
	...
	public void setupRequirements()
	{
		...
		fairyRingAccess = new QuestRequirement(github.questitemsQuest.FAIRYTALE_II__CURE_A_QUEEN, QuestState.IN_PROGRESS, "Fairy ring access");
		fairyRingAccess.setTooltip(github.questitemsQuest.FAIRYTALE_II__CURE_A_QUEEN.getName() + " is required to at least be started in order to use fairy rings");
	...
	public ArrayList<Requirement> getGeneralRequirements()
	{
		...
		reqs.add(new QuestRequirement(github.questitemsQuest.ALFRED_GRIMHANDS_BARCRAWL, QuestState.FINISHED));
