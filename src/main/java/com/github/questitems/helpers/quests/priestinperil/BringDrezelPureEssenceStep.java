package com.github.questitems.helpers.quests.priestinperil;
...
public class BringDrezelPureEssenceStep extends NpcStep
{
	...
	public BringDrezelPureEssenceStep(github.questitems github.questitems)
	{
		super(github.questitems, NpcID.DREZEL, new WorldPoint(3439, 9896, 0), "Bring Drezel 50 UNNOTED rune/pure essence in the underground of the Salve Temple to finish the quest!");
