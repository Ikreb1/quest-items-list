package com.github.questitems.helpers.quests.dwarfcannon;
...
@QuestDescriptor(
        quest = github.questitemsQuest.DWARF_CANNON
)

public class DwarfCannon extends Basicgithub.questitems
{
	//Items Recommended
