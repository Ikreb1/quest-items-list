package com.github.questitems.helpers.quests.beneathcursedsands;
...
public class TombRiddle extends DetailedOwnerStep
{
	...
	public TombRiddle(github.questitems github.questitems)
	{
		super(github.questitems, "Solve the riddle.");
	...
	{
		inspectPlaque = new ObjectStep(github.questitems, NullObjectID.NULL_20391, new WorldPoint(3391, 9251, 0), "Inspect the north-western plaque and read it.");
		obtainEmblems = new ObjectStep(github.questitems, NullObjectID.NULL_20392, new WorldPoint(3391, 9245, 0), "Inspect the south-western plaque to get four emblems.");
		pullLever = new ObjectStep(github.questitems, NullObjectID.NULL_20288, new WorldPoint(3390, 9247, 0), "Pull the lever to the south-west.");

		placeNorthernUrn = new ObjectStep(github.questitems, NullObjectID.NULL_44590, "Place the emblem in the northernmost urn.");
		placeCentreNorthUrn = new ObjectStep(github.questitems, NullObjectID.NULL_44589, "Place the emblem in the centre-north urn.");
		placeCentreSouthUrn = new ObjectStep(github.questitems, NullObjectID.NULL_44588, "Place the emblem in the centre-south urn.");
		placeSouthernUrn = new ObjectStep(github.questitems, NullObjectID.NULL_44587, "Place the emblem in the southernmost urn.");
